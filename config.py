...
#OWNER ID
OWNER_ID = int(os.environ.get("OWNER_ID", "5826613686"))
...
DB_NAME = os.environ.get("DATABASE_NAME", "Clufgtggfster2")
...
USER_REPLY_TEXT = "<blockquote>ᴀʀᴀ!! ᴀʀᴀ!! ɪᴀᴍ ᴏɴʟʏ ᴡᴏʀᴋ ғᴏʀ ᴍʏ ʟᴏᴠᴇʟʏ ᴋᴀᴡᴀɪɪ 🥰 @Anime_StarDust !</blockquote>"
